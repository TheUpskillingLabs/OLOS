---
slug: just-do-it-user-experience-expert-eric-meniefield-shares-insights-with-upskillers
title: "Just Do It: User Experience Expert Eric Meniefield Shares Insights with Upskillers"
type: post
status: published
date: 2026-06-05
author: Matt Michael
summary: "*Meniefield conducting an online UX design workshop with Upskillers.*"
source_url: https://theupskillinglabs.org/newsroom/user-experience-expert-eric-meniefield-shares-insights-with-upskillers
---
...
Lifted by his “faith-without-works” approach, Meniefield became the founder and executive director of [Wrkz](https://www.wrkz.org/) Inc. (pronounced “Works”), a nonprofit based in Los Angeles that [expands economic and career mobility](https://www.youtube.com/watch?v=n_7DXNFJwcI) for emerging creators and entrepreneurs from underserved communities.

When [Dr. Tati Warren](https://www.linkedin.com/in/drtatiwarren/), a founding member and board member of The Upskilling Labs, met Meniefield at a National Science Foundation conference in Michigan, she immediately recognized the synergy between Wrkz and The Upskilling Labs and asked Meniefield to share his expertise on user experience design with the “Upskillers.” [The Upskilling Labs](https://theupskillinglabs.org/) is a civic learning community that helps mission-driven professionals put their faith into action by exploring how emerging technology and skill-sharing can create new value for local communities.
...
*Wrkz Inc. creators, mentors, and vendors are celebrating the completion of a 5-week User Experience immersive course through project presentations, certificate awards, and a ribbon-cutting ceremony. Photo courtesy of Wrkz Inc.*
...
*Wrkz Inc.’s 5-week User Experience Immersive is a project-based training program that equips underserved young creators and entrepreneurs with foundational UX design, and digital problem-solving skills through hands-on paid learning, mentorship, and real-world project collaboration. Photo courtesy of Wrkz Inc.*
...
For more information on The Upskilling Labs and its current program on solving issues related to energy and climate, visit the [program webpage](https://theupskillinglabs.org/programming/energyandclimate) and [event calendar](https://luma.com/theupskillinglabs), and connect on [LinkedIn](https://www.linkedin.com/company/theupskillinglabs/posts/?feedView=all).
