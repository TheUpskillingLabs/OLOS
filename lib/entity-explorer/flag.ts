...
//
// Default OFF: unless ENTITY_EXPLORER_ENABLED is "true" (case-insensitive,
// surrounding whitespace ignored), the route 404s and the nav link is hidden —
// the feature is invisible and inert. So "true", "True", "TRUE" all enable it.
// Flipping this
...
export const ENTITY_EXPLORER_ENABLED =
  process.env.ENTITY_EXPLORER_ENABLED?.trim().toLowerCase() === "true";
