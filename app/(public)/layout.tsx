...
import { PgFoot } from "@/app/components/chrome/site-footers";
import { publicSession } from "@/lib/auth/public-session";

/* The public content pages' shell (events/library/labs/about/build-cycles):
   the dark public nav and the compact footer. Every page here ships the same
   chrome — the prototype generator's shell(). */
