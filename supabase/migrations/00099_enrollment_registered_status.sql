-- 00099_enrollment_registered_status.sql
--
-- ALREADY APPLIED TO THE DEV DATABASE on 2026-07-31, under its original name
-- 00092_enrollment_registered_status.sql. Dev had meanwhile spent 00092 on the
-- events taxonomy migration, so this file carries 00099 for prod's benefit.
-- Do NOT re-run it against dev: step 2's backfill is not a no-op once new
-- genuine revocations have landed. Prod has not seen it yet.
--
...
--    (which the pre-00099 reconciler wrote as 'inactive' without an audit
